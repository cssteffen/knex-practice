...
describe("Articles service object", function() {
  ...
  let testArticles = [
    {
      ...
      content:
        "consectetur adipisicing elit. Natus consequuntur deserunt commodi, nobis qui inventore corrupti iusto aliquid debitis unde non.Adipisci, pariatur.Molestiae, libero esse hic adipisci autem neque ?"
    },
    {
      id: 2,
  ...
  before(() => db("blogful_articles").truncate()); //this removed all data from table
  afterEach(() => db("blogful_articles").truncate()); //eliminates test leaks
  after(() => db.destroy());
  ...
  context("Given 'blogful_articles' has data", () => {
    ...
    //
    it('getById() resoloves an article by id from "blogful_articles" table', () => {
      const thirdId = 3;
